...
<ol>
<li><span style="color: #993300;"><strong>SCE(Strict Contextual Escaping)</strong> 을 통한<strong> XSS, 클랙재킹 </strong>등의 보안 대책.</span></li>
<li><strong>jqLite</strong>가 내장되어 있어 기본적인 <span>jQuery </span>함수 사용 가능<span>.</span></li>
<li>controller에 해당되는<span> js</span>의 작성이<span> callback </span>형태로 되어 있어<span>, </span>노출을 원하는 부분은<span> view</span>쪽에 설정해 주고<span>, </span>처리 부분은<span> js</span>에서 인자로 넘겨 받아 처리 요청만 하면 되는 형태<span>. (filter)<br /> ex) </span><span><a href="http://tutorialzine.com/2013/08/learn-angularjs-5-examples/">http://tutorialzine.com/2013/08/learn-angularjs-5-examples/</a></span> ( 4. Instant Search )</li>
<li>AngularJS Hint <br /> - 개발 모범 사례 준수 여부 체크<span><br /> - </span><span><a href="https://github.com/angular/angular-hint">https://github.com/angular/angular-hint</a></span><br /><br /><br />
<pre><code>&lt;script type="text/javascript" src="resources/angularjs/hint.js"&gt;&lt;/script&gt; <br />&lt;html lang="ko" data-ng-app="App" ng-hint&gt;
</code></pre>
<br />&nbsp;</li>
</ol>
<ol start="5">
<li>AngularJS 성능 체크<span><br /> -https://chrome.google.com/webstore/detail/angularjs-batarang/ighdmehidhipcmcojjgiloacoafjmpfk<br /> - </span>크롬 익스텐션으로<span> AngularJS </span>탭<span> enable </span>체크<span><br /> </span></li>
