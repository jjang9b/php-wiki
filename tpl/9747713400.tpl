...
<pre><code class="javascript">// module/char.js<br />define(["module/log"], function (log) {<br /> function change() {<br /> /* .. char change action */<br /> log.write( "Log Write complete" );<br /> }<br /> return {<br /> change: change<br /> }<br />});<br /><br />// module/log.js<br />define([], function () {<br /> function write( logConts ) {<br /> console.log( logConts );<br /> }<br /> return {<br /> write: write<br /> }<br />});<br /><br />// main.js<br />require(["module/char"], function(char) {<br /> char.change();<br /> /* Console.log : Log Write complete */<br />});<br /></code></pre>
